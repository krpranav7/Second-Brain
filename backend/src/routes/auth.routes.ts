...
import { addContent, deleteContent, getContents, getSharedBrain, loginUser, logoutUser, registerUser, shareBrain, getCurrentUser, updateProfile, changePassword } from "../controllers/auth.controller.js";
...
router.patch('/me', authUserMiddleware, updateProfile);
router.patch('/me/password', authUserMiddleware, changePassword);
